...
public class shop_donate_confirm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_donate_confirm);
        ...
        setpoints();
        getUserinfo();
        btn1=findViewById(R.id.shop_confirm_finald);
        btn1.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                plus(-20);
                gv.setb(b);
                Intent intent= new Intent(shop_donate_confirm.this,greenshop_donations.class);
